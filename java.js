...
var initialAndScore = document.querySelector("#hs");
...
var questions = [
    ...
    },
    {
        ...
        choices: ["quotes", "curly brackets", "parenthises", "square brackets"],
        answer: "parenthises",
    },
    {
...
function onclickHandler(event) {
    ...
    if (answerText === questions[ind].answer) {
        timer = timer;
...
function displayQuestions() {
    var holdQ1Title = questions[ind].title
    hEl.textContent = holdQ1Title
    var holdq1Choice1 = questions[ind].choices[0];
    var holdq1Choice2 = questions[ind].choices[1];
    var holdq1Choice3 = questions[ind].choices[2];
    var holdq1Choice4 = questions[ind].choices[3];
